   ...
   ###################################################################################################
    ...
    def _open_plot_config_menu(self):
        ...
        if self.open_config:
            ...
            annot_mode = self.mode_toggle_fannot.is_checked()
            plot_config_widget = Plot_Config_Menu(plot_config=self.dm.plot_config, label_mode=label_mode, annot_mode=annot_mode)
